...
class OpenBlockArduinoK210MaixDockDevice {
    ...
    get MODE_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.modeMenu.input',
                    default: 'input',
            ...
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.modeMenu.output',
                    default: 'output',
            ...
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.modeMenu.inputPullup',
            ...
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.modeMenu.inputPulldown',
    ...
    get LEVEL_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.levelMenu.high',
                    default: 'high',
            ...
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.levelMenu.low',
                    default: 'low',
    ...
    get INTERRUP_MODE_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.InterrupModeMenu.risingEdge',
                    default: 'rising edge',
            ...
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.InterrupModeMenu.fallingEdge',
            ...
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.InterrupModeMenu.changeEdge',
                    default: 'change edge',
            ...
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.InterrupModeMenu.low',
                    default: 'low level',
            ...
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.InterrupModeMenu.high',
                    default: 'high level',
    ...
    get EOL_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.eolMenu.warp',
                    default: 'warp',
            ...
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.eolMenu.noWarp',
                    default: 'no-warp',
    ...
    get DATA_TYPE_MENU () {
        return [
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.dataTypeMenu.integer',
                    default: 'integer',
            ...
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.dataTypeMenu.decimal',
                    default: 'decimal',
            ...
            {
                text: formatMessage({
                    id: 'arduinoK210MaixDock.dataTypeMenu.string',
                    default: 'string',
        ...
        return [
            {
                id: 'pin',
                name: formatMessage({
                    id: 'arduinoK210MaixDock.category.pins',
                    default: 'Pins',
                    description: 'The name of the arduino K210 MaixDock device pin category'
                }),
                color1: '#4C97FF',
                color2: '#3373CC',
                color3: '#3373CC',
                blocks: [
                    {
                        opcode: 'setPinMode',
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.pins.setPinMode',
                            default: 'set pin [PIN] mode [MODE]',
                            description: 'arduinoK210MaixDock set pin mode'
                        }),
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.pins.setDigitalOutput',
                            default: 'set digital pin [PIN] out [LEVEL]',
                            description: 'arduinoK210MaixDock set digital pin out'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
                    ...
                    },
                    {
                        opcode: 'setPwmOutput',
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.pins.setPwmOutput',
                            default: 'set pwm pin [PIN] out [OUT]',
                            description: 'arduinoK210MaixDock set pwm pin out'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.pins.readDigitalPin',
                            default: 'read digital pin [PIN]',
                            description: 'arduinoK210MaixDock read digital pin'
                        }),
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.pins.setServoOutput',
                            default: 'set servo pin [PIN] out [OUT]',
                            description: 'arduinoK210MaixDock set servo pin out'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
                    ...
                    '---',
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.pins.attachInterrupt',
                            default: 'attach interrupt pin [PIN] mode [MODE] executes',
                            description: 'arduinoK210MaixDock attach interrupt'
                        }),
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.pins.detachInterrupt',
                            default: 'detach interrupt pin [PIN]',
                            description: 'arduinoK210MaixDock detach interrupt'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            PIN: {
            ...
            },
            {
                id: 'serial',
                name: formatMessage({
                    id: 'arduinoK210MaixDock.category.serial',
                    default: 'Serial',
                    description: 'The name of the arduino K210 MaixDock device serial category'
                }),
                color1: '#9966FF',
                color2: '#774DCB',
                color3: '#774DCB',
                blocks: [
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.serial.multiSerialBegin',
                            default: 'serial [NO] begin baudrate [BAUD] pin RX [RX_PIN] TX [TX_PIN]',
                            description: 'arduinoK210MaixDock multi serial begin'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            NO: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.serial.multiSerialPrint',
                            default: 'serial [NO] print [VALUE] [EOL]',
                            description: 'arduinoK210MaixDock multi serial print'
                        }),
                        blockType: BlockType.COMMAND,
                        arguments: {
                            NO: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.serial.multiSerialAvailable',
                            default: 'serial [NO] available data length',
                            description: 'arduinoK210MaixDock multi serial available data length'
                        }),
                        arguments: {
                            NO: {
                                type: ArgumentType.NUMBER,
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.serial.multiSerialReadAByte',
                            default: 'serial [NO] read a byte',
                            description: 'arduinoK210MaixDock multi serial read a byte'
                        }),
                        arguments: {
                            NO: {
                                type: ArgumentType.NUMBER,
            ...
            },
            {
                id: 'data',
                name: formatMessage({
                    id: 'arduinoK210MaixDock.category.data',
                    default: 'Data',
                    description: 'The name of the arduino K210 MaixDock device data category'
                }),
                color1: '#CF63CF',
                color2: '#C94FC9',
                color3: '#BD42BD',
                blocks: [
                    {
                        opcode: 'dataMap',
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.data.dataMap',
                            default: 'map [DATA] from ([ARG0], [ARG1]) to ([ARG2], [ARG3])',
                            description: 'arduinoK210MaixDock data map'
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.data.dataConstrain',
                            default: 'constrain [DATA] between ([ARG0], [ARG1])',
                            description: 'arduinoK210MaixDock data constrain'
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
                    ...
                    '---',
                    {
                        opcode: 'dataConvert',
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.data.dataConvert',
                            default: 'convert [DATA] to [TYPE]',
                            description: 'arduinoK210MaixDock data convert'
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.data.dataConvertASCIICharacter',
                            default: 'convert [DATA] to ASCII character',
                            description: 'arduinoK210MaixDock data convert ASCII character'
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
                    ...
                    },
                    {
                        ...
                        text: formatMessage({
                            id: 'arduinoK210MaixDock.data.dataConvertASCIINumber',
                            default: 'convert [DATA] to ASCII nubmer',
                            description: 'arduinoK210MaixDock data convert ASCII number'
                        }),
                        blockType: BlockType.REPORTER,
                        arguments: {
                            DATA: {
